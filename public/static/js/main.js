    ...
    fn_slideshow: function() {
      if ($('#homeBgSlideshow').is(':visible')) {
        $('#homeBgSlideshow').vegas({
          slides: [
            { src: 'https://ojrbqzf6q.qnssl.com/2018041655894home-bg-slide-1.jpg' },
            { src: 'https://ojrbqzf6q.qnssl.com/2018041667259home-bg-slide-2.jpg' },
            { src: 'https://ojrbqzf6q.qnssl.com/201804167202home-bg-slide-3.jpg' },
          ],
          delay: 7000
        });
      }
